...
test('Alterar dado de classe com atributos _Key e n�o _Key', () => {
...
test('Tentativa de altera��o em tabela n�o existente', async () => {
...
test('Tentativa de altera��o em coluna n�o existente', async () => {
...
test('Tentativa de altera��o com dados de conex�o incorretos', async () => {
